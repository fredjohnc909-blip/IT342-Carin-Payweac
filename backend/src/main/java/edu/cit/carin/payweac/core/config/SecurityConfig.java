...
import edu.cit.carin.payweac.core.security.JwtFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/auth/register", "/api/v1/auth/login", "/api/v1/payments/delete-dupes", "/api/v1/admin/rents/delete-dupes").permitAll()
